...
func receive_raw_smf_midi_event(channel_number: int, event: SMF.MIDIEvent ) -> void:
    #
    # 生MIDIメッセージ処理
    # @param	input_event	イベント
    #

    var channel:GodotMIDIPlayerChannelStatus = self.channel_status[channel_number]
